...
// 출처 [Sebastian Lague]
// 영상 링크: https://youtu.be/D3gbXAVcG-0
...
public class CameraShake : MonoBehaviour
{
    ...
    public class Data
    {
        ...
        public Data(float angle, float strength, float speed, float duration, float noisePercent, float dampingPercent, float rotationPercent)
        {
            this.angle = angle;
    ...
    public void StartShake(Data properties)
    {
    ...
    IEnumerator Shake(Data properties)
    {
